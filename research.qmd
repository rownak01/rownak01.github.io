...
- Fuel consumption within **1.1 to 4.8%** of the dynamic programming (DP) optimum
...
- **Embedded C-HIL Deployment:** Trained PA-SAC policies deployed on a Speedgoat real-time controller in a hardware-in-the-loop testbench, reproducing training-time control behavior across multiple drive cycles and agents
